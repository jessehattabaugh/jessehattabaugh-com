...
const url = 'http://localhost:1234/share.html';
...
describe('the home page', () => {
	it('looks right on mobile', async () => {
		...
		await page.goto(url);
		const currPath = 'shots/share.mobile.curr.png';
		const refPath = 'shots/share.mobile.ref.png';
		const diffPath = 'shots/share.mobile.diff.png';
	...
	it('looks right on desktop', async () => {
		...
		await page.goto(url);
		const currPath = 'shots/share.desktop.curr.png';
		const refPath = 'shots/share.desktop.ref.png';
		const diffPath = 'shots/share.desktop.diff.png';
		await page.screenshot({
			path: currPath,
			fullPage: true,
		});
